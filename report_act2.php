        ...
        <div class="container">
            <div class="row">
                ...
                <?php 
                    ...
                    $countBC="SELECT COUNT(activities_id) AS countBC FROM activities WHERE atttype_id = '6' AND activities.activities_year = '$year'" ;
                    ...
                    $countBS="SELECT COUNT(activities_id) AS countBS FROM activities WHERE atttype_id = '7' AND activities.activities_year = '$year'" ;
                    ...
                    $countHD="SELECT COUNT(activities_id) AS countHD FROM activities WHERE atttype_id = '1' AND activities.activities_year = '$year'" ;
                    ...
                    $countCD="SELECT COUNT(activities_id) AS countCD FROM activities WHERE atttype_id = '4'AND activities.activities_year = '$year'" ;
                    ...
                    $countMD="SELECT COUNT(activities_id) AS countMD FROM activities WHERE atttype_id = '3'AND activities.activities_year = '$year'" ;
                    ...
                    $countAD="SELECT COUNT(activities_id) AS countAD FROM activities WHERE atttype_id = '2' AND activities.activities_year = '$year'" ;
                    ...
                    $countPD="SELECT COUNT(activities_id) AS countPD FROM activities WHERE atttype_id = '5'AND activities.activities_year = '$year'" ;
                    ...
                    $countTotal="SELECT COUNT(activities_id) AS countTotal FROM activities WHERE activities.activities_year = '$year'" ;
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    ...
                    <?php
                        ...
                        var chart = new CanvasJS.Chart("chartContainer", {
                          ...
                          exportEnabled: true,
                          title:{
                            text: "กิจกรรมทั้งหมดในปี <?php echo $year ?>"
                          },
                          subtitles: [{
                         ...
                         <br>                              
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="data-table-basic" class="table table-hover table-inbox">
                                                                    ...
                                                                    <tbody>
                                                                        <?php 
                                                                            $sql = "SELECT * FROM activities INNER JOIN activities_type on activities.atttype_id = activities_type.atttype_id  WHERE activities.activities_year = '$year' ORDER BY activities_id DESC";//ORDER BY คือการเรียงตามลำดับ ID
                                                                            ...
                                                                            $res_actt = mysqli_query($con,$sql);
                                                                                while($row_actt = mysqli_fetch_assoc($res_actt)){
                                                                                    
                                                                            ?>
                                                                        <tr>
                                                                            <td class="ct"><a href="report_act.php?id=<?= $row_actt['activities_id']; ?>"style="color:#000000;"><?php echo $row_actt['activities_id']; ?></td>
                                                                            <td><a href="report_act.php?id=<?= $row_actt['activities_id']; ?>"style="color:#000000;"><?php echo $row_actt['activities_topic']; ?></td>                         
                                                                            <td class="ct"><a href="report_act.php?id=<?= $row_actt['activities_id']; ?>"style="color:#000000;"><?php echo $row_actt['atttype_detail']; ?></td>
                                                                            <td class="ct"><a href="report_act.php?id=<?= $row_actt['activities_id']; ?>"style="color:#000000;"><?php echo $row_actt['activities_year']; ?></td>
                                                                        </tr>
                                                                        <?php } ?>
