...
$sql = "SELECT class_id FROM students WHERE student_id = '".$student_id."' ";//ORDER BY คือการเรียงตามลำดับ ID
        ...
        if($result->num_rows > 0){
            ...
            while($row = $result->fetch_assoc()) {
                $dbresult[] = array("class_id"=>$row["class_id"]);
            }
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_class.log", 'a+');
