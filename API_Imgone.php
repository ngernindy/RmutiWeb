...
$sql = "SELECT * FROM activities_join WHERE student_id = '".$student_id."' AND activities_id = '".$activities_id."' ";//ORDER BY คือการเรียงตามลำดับ ID
        ...
        if($result->num_rows > 0){
            ...
            while($row = $result->fetch_assoc()) {
                $dbresult[] = array("join_id"=>$row["join_id"]);
            }
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_Imgone.log", 'a+');
