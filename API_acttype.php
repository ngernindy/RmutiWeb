...
$sql = "SELECT * FROM activities_type ";//ORDER BY คือการเรียงตามลำดับ ID
        ...
        if($result->num_rows > 0){
            ...
            while($row = $result->fetch_assoc()) {
                $dbresult[] = array("atttype_id"=>$row["atttype_id"],"atttype_detail"=>$row["atttype_detail"]);
            }
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_acttype.log", 'a+');
