...
$sql="SELECT COUNT(activities.activities_id) AS countMD FROM activities INNER JOIN activities_join ON activities.activities_id = activities_join.activities_id  WHERE activities_join.student_id='".$student_id."' AND atttype_id ='3' ";
        ...
        if($result->num_rows > 0){
            ...
            while($row = $result->fetch_assoc()) {
                $dbresult[] = array("countMD"=>$row["countMD"]);
            }
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_COUNT_MD.log", 'a+');
