...
// $sql = "SELECT * FROM news INNER JOIN newstype ON news.newstype_id=newstype.newstype_id WHERE newstype.newstype_id = '001' AND news_date>=date_add(curdate(),interval -200 day) ORDER BY news_id DESC";//ORDER BY คือการเรียงตามลำดับ ID

$sql = "SELECT * FROM news INNER JOIN newstype ON news.newstype_id=newstype.newstype_id WHERE newstype.newstype_id = '001' ORDER BY news_id DESC";//ORDER BY คือการเรียงตามลำดับ ID
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_news_PR.log", 'a+');
