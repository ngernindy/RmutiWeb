...
// $sql = "SELECT * FROM news INNER JOIN newstype ON news.newstype_id=newstype.newstype_id WHERE news_date>=date_add(curdate(),interval -200 day) ORDER BY news_id DESC";//ORDER BY คือการเรียงตามลำดับ ID
...
// WHERE news_date>=date_add(curdate(),interval -90 day) คือตั้งเวลาแสดงข่าว
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_news_total.log", 'a+');
