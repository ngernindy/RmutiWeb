...
$sql = "SELECT * FROM text_activities INNER JOIN students_class ON text_activities.class_id=students_class.class_id INNER JOIN activities_type ON text_activities.atttype_id=activities_type.atttype_id WHERE students_class.class_id = '".$class_id."' AND activities_type.atttype_id = '2'";
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_textAD.log", 'a+');
