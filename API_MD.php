...
$sql = "SELECT * FROM activities_join INNER JOIN activities ON activities_join.activities_id=activities.activities_id WHERE student_id = '".$student_id."' AND atttype_id='3'";//ORDER BY คือการเรียงตามลำดับ ID
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_MD.log", 'a+');
