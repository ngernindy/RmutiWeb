<?php 
    ...
    $countNews="SELECT COUNT(newstype_id) AS countNews FROM news ";
...
<body>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>รายงานข่าว</h2>
										<p>ข่าวทั้งหมด <span class="bread-ntd"><?php echo $countNews ?> ข่าว</span></p>
									</div>
								</div>
							</div>
    ...
    <?php
      ...
      $countNews1="SELECT COUNT(newstype_id) AS countNews1 FROM news WHERE newstype_id = '001' ";
      ...
      $countNews2="SELECT COUNT(newstype_id) AS countNews2 FROM news WHERE newstype_id = '002' ";
                  ...
                  <div class="view-mail-list sm-res-mg-t-30">
                    <?php
                        ...
                        var chart = new CanvasJS.Chart("chartContainer", {
                          ...
                          exportEnabled: true,
                          title:{
                            text: "ข่าวทั้งหมด <?php echo $countNews ?> ข่าว"
                          },
                          subtitles: [{
                            text: ""
                          }],
                        ...
                        <br>
                        <br>
                        <form action="reportNews2.php" method="get" enctype="multipart/form-data">
