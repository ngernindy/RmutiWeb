...
$sql = "SELECT * FROM activities WHERE activities_date>=date_add(curdate(),interval -90 day) ORDER BY activities_date DESC";//ORDER BY คือการเรียงตามลำดับ ID
...
$message = $date."||".$sql."\r\n";
$objFopen = @fopen("sql_log_API_act.log", 'a+');
